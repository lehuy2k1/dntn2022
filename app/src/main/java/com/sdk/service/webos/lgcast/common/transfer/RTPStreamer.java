 ...
 */
package com.sdk.service.webos.lgcast.common.transfer;

import android.content.Context;

import com.sdk.GStreamer;
import com.sdk.service.webos.lgcast.common.transfer.RTPStreamerConfig.AudioConfig;
import com.sdk.service.webos.lgcast.common.transfer.RTPStreamerConfig.SecurityConfig;
import com.sdk.service.webos.lgcast.common.transfer.RTPStreamerConfig.VideoConfig;
import com.sdk.service.webos.lgcast.common.transfer.RTPStreamerData.MediaType;
import com.sdk.service.webos.lgcast.common.transfer.RTPStreamerData.ProtocolType;
import com.sdk.service.webos.lgcast.common.transfer.RTPStreamerSetting.StreamSetting;
import com.sdk.service.webos.lgcast.common.utils.Logger;
import com.sdk.service.webos.lgcast.common.utils.ThreadWait;
...
public class RTPStreamer {
    ...
    public void setVideoConfig(VideoConfig config) {
        try {
            if (config == null || config.bitrate <= 0 || config.framerate <= 0)
                throw new Exception("Invalid arguments");
            if (mStreamSetting == null || mStreamSetting.videoStreamInfo == null)
    ...
    public void setAudioConfig(AudioConfig config) {
        try {
            ...
            if (mStreamSetting == null || mStreamSetting.audioStreamInfo == null)
                throw new Exception("Invalid stream setting");
    ...
    public void setSecurityConfig(SecurityConfig config) {
        try {
            if (config == null) throw new Exception("Invalid arguments");
            if (mStreamSetting == null || mStreamSetting.securityInfo == null)
                throw new Exception("Invalid stream setting");
    ...
    public boolean start() {
        ...
        try {
            ...
            if (mStreamSetting.audioStreamInfo != null && mStreamSetting.audioStreamInfo.isCompleted() == false)
                throw new Exception("Need to init audio info!!");
            if (mStreamSetting.videoStreamInfo != null && mStreamSetting.videoStreamInfo.isCompleted() == false)
                throw new Exception("Need to init video info!!");
            if (mStreamSetting.securityInfo != null && mStreamSetting.securityInfo.isCompleted() == false)
                throw new Exception("Need to init security info!!");

            nativeSetStreamInfo(mStreamSetting);
            nativeStart();

            if (mStartWait.waitFor(3000, false) == false)
