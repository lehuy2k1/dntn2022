...
public class DetailAlbumPhotoAdapter extends RecyclerView.Adapter<DetailAlbumPhotoAdapter.DetailAlbumViewHolder> {
    private Context mContext;
    private ArrayList<String> mData;
    private OnClickItemListener<String> onClickItemListener;
    private LayoutInflater mLayoutInflater;

    public DetailAlbumPhotoAdapter(Context mContext, OnClickItemListener<String> onClickItemListener) {
    ...
    public DetailAlbumViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = mLayoutInflater.inflate(R.layout.item_detail_album_photo, parent, false);
    ...
    public class DetailAlbumViewHolder extends RecyclerView.ViewHolder {
        ...
        public DetailAlbumViewHolder(@NonNull View itemView) {
            super(itemView);
            imvDetailAlbumPhoto = itemView.findViewById(R.id.imv_detail_album_photo);
        }
    }
}
